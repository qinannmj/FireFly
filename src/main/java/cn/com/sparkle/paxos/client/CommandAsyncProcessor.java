...
import cn.com.sparkle.paxos.net.client.user.ConnectConfig.ConnectEvent;
import cn.com.sparkle.paxos.net.client.user.UserClientHandler;
import cn.com.sparkle.paxos.net.client.user.UserNetNode;
...
public class CommandAsyncProcessor implements Runnable {
	...
	private void sendRequestToNode(UserNetNode node, EntryNode entryNode) throws NetCloseException {
		...
		if (entryNode.c.getValue() == null) {
			...
			node.sendAddRequest(entryNode.c.getCommandType(), entryNode.c.getValue(), callback);
		}
	}
