...
import cn.com.sparkle.paxos.protocolprocessor.AbstraceProtocol;
...
import cn.com.sparkle.paxos.protocolprocessor.v0_0_1.PaxosMessages.ActiveHeartBeatRequest;
import cn.com.sparkle.paxos.protocolprocessor.v0_0_1.PaxosMessages.AddRequest;
...
import cn.com.sparkle.paxos.protocolprocessor.v0_0_1.PaxosMessages.CommandResponse;
import cn.com.sparkle.paxos.protocolprocessor.v0_0_1.PaxosMessages.ConnectRequest;
import cn.com.sparkle.paxos.protocolprocessor.v0_0_1.PaxosMessages.ElectionId;
import cn.com.sparkle.paxos.protocolprocessor.v0_0_1.PaxosMessages.ElectionPrepareRequest;
import cn.com.sparkle.paxos.protocolprocessor.v0_0_1.PaxosMessages.ElectionSuccessMessage;
import cn.com.sparkle.paxos.protocolprocessor.v0_0_1.PaxosMessages.ElectionVoteRequest;
import cn.com.sparkle.paxos.protocolprocessor.v0_0_1.PaxosMessages.HeartBeatRequest;
import cn.com.sparkle.paxos.protocolprocessor.v0_0_1.PaxosMessages.InstancePrepareRequest;
import cn.com.sparkle.paxos.protocolprocessor.v0_0_1.PaxosMessages.InstanceSuccessMessage;
import cn.com.sparkle.paxos.protocolprocessor.v0_0_1.PaxosMessages.InstanceSuccessTransport;
import cn.com.sparkle.paxos.protocolprocessor.v0_0_1.PaxosMessages.InstanceVoteRequest;
import cn.com.sparkle.paxos.protocolprocessor.v0_0_1.PaxosMessages.LookUpLatestInstanceIdRequest;
...
import cn.com.sparkle.paxos.protocolprocessor.v0_0_1.system.ActiveHeartProcessor;
import cn.com.sparkle.paxos.protocolprocessor.v0_0_1.system.AssignSelfElectionProcessor;
import cn.com.sparkle.paxos.protocolprocessor.v0_0_1.system.CatchupRequestProcessor;
import cn.com.sparkle.paxos.protocolprocessor.v0_0_1.system.ElectionPrepareRequestProcessor;
import cn.com.sparkle.paxos.protocolprocessor.v0_0_1.system.ElectionSuccessRequestProcessor;
import cn.com.sparkle.paxos.protocolprocessor.v0_0_1.system.ElectionVoteRequestProcessor;
import cn.com.sparkle.paxos.protocolprocessor.v0_0_1.system.InstancePrepareRequestProcessor;
import cn.com.sparkle.paxos.protocolprocessor.v0_0_1.system.InstanceSuccessRequestProcessor;
import cn.com.sparkle.paxos.protocolprocessor.v0_0_1.system.InstanceVoteRequestProcessor;
import cn.com.sparkle.paxos.protocolprocessor.v0_0_1.system.LookupLastestInstanceIdRequestProcessor;
import cn.com.sparkle.paxos.protocolprocessor.v0_0_1.system.SenatorHeartBeatProcessor;
import cn.com.sparkle.paxos.protocolprocessor.v0_0_1.system.callback.CatchUpCallBackV0_0_1;
import cn.com.sparkle.paxos.protocolprocessor.v0_0_1.system.callback.InstanceSuccessCallBackV0_0_1;
import cn.com.sparkle.paxos.protocolprocessor.v0_0_1.system.callback.LookUpLatestInstanceIdCallBackV0_0_1;
import cn.com.sparkle.paxos.protocolprocessor.v0_0_1.system.callback.PrepareCallBackV0_0_1;
import cn.com.sparkle.paxos.protocolprocessor.v0_0_1.system.callback.VoteCallBackV0_0_1;
import cn.com.sparkle.paxos.protocolprocessor.v0_0_1.user.AddRequestProcessor;
import cn.com.sparkle.paxos.protocolprocessor.v0_0_1.user.ConnectRequestProcessor;
import cn.com.sparkle.paxos.protocolprocessor.v0_0_1.user.UserHeartBeatProcessor;
import cn.com.sparkle.paxos.protocolprocessor.v0_0_1.user.callback.AddRequestCallBackV0_0_1;
import cn.com.sparkle.paxos.protocolprocessor.v0_0_1.user.callback.ConnectRequestCallBackV0_0_1;
import cn.com.sparkle.paxos.stablestorage.model.StoreModel;
import cn.com.sparkle.paxos.stablestorage.util.IdTranslator;
...
public class ProtocolV0_0_1 extends AbstraceProtocol {
	...
	public static ProtocolV0_0_1 createServerProtocol(Context context, HandlerInterface userHandlerInterface, HandlerInterface adminHandlerInterface) {
		...
		serverInprotocolChain.addFirst(new AssignSelfElectionProcessor(context));
	...
	public CallBack<? extends Object> createHeartBeatCallBack(HeartBeatCallBack callback) {
		return new cn.com.sparkle.paxos.protocolprocessor.v0_0_1.system.callback.HeartBeatCallBackV0_0_1(callback);
	}

	@Override
	public byte[] createElectionPrepareRequest(long packageId, long lastVoteId, cn.com.sparkle.paxos.model.ElectionId id) {
	...
	@Override
	public byte[] createElectionSuccessRequest(long packageId, cn.com.sparkle.paxos.model.ElectionId electionId) {
	...
	@Override
	public byte[] createElectionVoteRequest(long packageId, long lastVoteId, cn.com.sparkle.paxos.model.ElectionId electionId) {
	...
	public byte[] createReElectionRequest(long packageId, String address) {
		ReAssignElectionRequest.Builder builder = ReAssignElectionRequest.newBuilder().setNodeId(address);
		return makeMessagePackage(packageId).setReAssignElectionRequest(builder).build().toByteArray();
	}
