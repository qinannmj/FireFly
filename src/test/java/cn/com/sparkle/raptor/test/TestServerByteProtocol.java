...
//		nsc.setRecieveBuffSize(32* 1024);
		...
		server.bind(new InetSocketAddress(1234),new MultiThreadProtecolHandler(1000, 8 * 1024, 2, 300, 60, TimeUnit.SECONDS,new ByteProtocol(1024), new TestByteProtocolHandler()));
